...
def crime_forecasting(KEYSPACE = 'pirates'):
    ...
    m.plot(forecast, xlabel='Date', ylabel='Crime Rate').savefig("../static/images/forecasting/forecast.png")
    m.plot_components(forecast).savefig("../static/images/forecasting/trends.png")
